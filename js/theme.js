...
$(theme.init);
 ...
 $( ".fp_content" ).addClass(function( index ) {
  return "c-" + index;
});
$( ".fp_image" ).addClass(function( index ) {
  return "i-" + index;
});



var imageGrad = $('.c-0'), image = $('.i-0 img');
function resizeDiv () { image.height(imageGrad.height() - 10); }
resizeDiv();
$(window).resize(function() { resizeDiv(); });
/*
var imageGrad1 = $('.c-1'), image1 = $('.i-1 img');
function resizeDiv1 () { image1.height(imageGrad1.height() - 10); }
resizeDiv1();
$(window).resize(function() { resizeDiv1(); });
*/

var imageGrad2 = $('.c-2'), image2 = $('.i-2 img');
function resizeDiv2 () { image2.height(imageGrad2.height() - 10); }
resizeDiv2();
$(window).resize(function() { resizeDiv2(); });

var imageGrad3 = $('.c-3'), image3 = $('.i-3 img');
function resizeDiv3 () { image3.height(imageGrad3.height() - 10); }
resizeDiv3();
$(window).resize(function() { resizeDiv3(); });

/*
function resizeMenu(){
    $(".fp_image.i-1 img").css("min-height",
        $(".fp_content.c-1").outerHeight()
    );
}
...
if ( ww <= 375 && ww >= 374 ) {
  ...
  var imgHeight = h * 0.55;
  var textHeight = h * 0.45;

  
  console.log(h);
  console.log(imgHeight);
  console.log(textHeight);
  $("#shopify-section-1606996999022561fe .flexslider ul li .slider_text").height(textHeight);
  $("#shopify-section-1606996999022561fe .flexslider .slides img").height(imgHeight);
}
else if (ww <= 480 && ww >= 376){
  var win = window,
      doc = document,
      docElem = doc.documentElement,
      body = doc.getElementsByTagName('body')[0],
...
$(".cart__additional_checkout").addClass("div-disabled");
$(document).ready(function() {
  $('body').on('click', '[name="checkout"]', function() {
    if ($('#agree').is(':checked')) {
      $(".cart__additional_checkout").removeClass("div-disabled");
    }
    else {
      $(".cart__additional_checkout").addClass("div-disabled");
    }
...
document.getElementById('agree').onchange = function(){
  ...
  if (this.checked) cart.classList.remove('hides');
  else cart.classList.add('hides');
}
